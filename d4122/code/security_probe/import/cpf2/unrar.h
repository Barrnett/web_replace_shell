...
CPF2_API HRESULT RARX(PTSTR ptzSrcFile, PTSTR ptzDstDir);
CPF2_API HRESULT RARGetCommon(PTSTR ptzSrcFile, std::string& strCommon);


//}

#else
CPF2_API int RARX(char* ptzSrcFile, char* ptzDstDir);
