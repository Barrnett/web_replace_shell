...
CPF_CLASS HRESULT RARX(PTSTR ptzSrcFile, PTSTR ptzDstDir);
CPF_CLASS HRESULT RARGetCommon(PTSTR ptzSrcFile, std::string& strCommon);


//}

#else
CPF_CLASS int RARX(char* ptzSrcFile, char* ptzDstDir);
