...
class PACKETIO_CLASS CEFilterSendPacket : CEtherSendPacketBase
{
public:
	CEFilterSendPacket(void);
	virtual ~CEFilterSendPacket(void);

public:
	BOOL Open(int drv_load_type,const char * sysfilename=NULL,
...
class PACKETIO_CLASS CEFilterWriteDataStream : public CEtherDataStreamBase
{
public:
	CEFilterWriteDataStream();
	virtual ~CEFilterWriteDataStream();
