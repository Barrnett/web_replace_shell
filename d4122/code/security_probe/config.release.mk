...
ifeq ($(OS), OS_LINUX)
OS_CC           := g++
OS_CCFLAGS      := -w  -Wno-deprecated -DOS_LINUX -DFLEX_IN_USE -fpermissive  -DACE_NDEBUG
# as5.0中不能使用 -Wstrict-prototypes 参数
OS_CFLAGS      := -Wall -Wno-deprecated -DOS_LINUX -DFLEX_IN_USE -fpermissive -DACE_NDEBUG
OS_CCDYNAFLAGS  := -fPIC
OS_CCDEBUGFLAGS := -O3 #-g
OS_CPP          := $(OS_CC) -E
OS_LD           := g++ 
