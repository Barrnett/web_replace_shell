...
BOOL CTS_MainNetL3::f_ModInit(CTS_InterfaceCfg* pTsInterfaceCfg, CTS_CONFIG* pTsConfig, ACE_Log_File_Msg* pLogFile, CArpTableEx * pArpTable)
{
	// 基础类的初始化
...
BOOL CTS_MainNetL3::f_ModUpdateCfg(CTS_CONFIG* pNewTsCfg)
{
...
void CTS_MainNetL3::f_HandleMyIcmp(PACKET_INFO_EX& packet_info)
{
	// IP头的长度
...
BOOL CTS_MainNetL3::f_HandleArp(PACKET_INFO_EX& packet_info)
{
...
BOOL CTS_MainNetL3::f_HandleIp(PACKET_INFO_EX& packet_info)
{
...
BOOL CTS_MainNetL3::f_HandlePacket(PACKET_INFO_EX& packet_info)
{
...
void CTS_MainNetL3::f_PeerDetect(ACE_UINT32 now_time)
{	
	m_nChkPeriod++;
...
void CTS_MainNetL3::f_MainNetCheck(ACE_UINT32 now_time)
{	
...
int CTS_MainNetL3::f_ForwardIp(PACKET_INFO_EX& packet_info)
{
...
int CTS_MainNetL3::f_ForwardArp(PACKET_INFO_EX& packet_info)
{
	return TRUE;
}
