...
BOOL CTS_BackNetL2::f_ForwardIp(PACKET_INFO_EX& packet_info, ACE_UINT32 des_index)
{
...
BOOL CTS_BackNetL2::f_MulticastIp(PACKET_INFO_EX& packet_info)
{	
	m_pTsInterfaceCfg->GetWriteDataStream()->WritePacket
	(
		PACKET_OK,
...
BOOL CTS_BackNetL2::f_ForwardArp(PACKET_INFO_EX& packet_info, ACE_UINT32 des_index)
{
	/*if (ECHO_OK != m_vtPeerDct[des_index]->m_eHostStat)
	{ 
		return FALSE; 
...
// 加入队列
BOOL CTS_BackNetL2::f_PushPktQueue(PACKET_INFO_EX& packet_info, ACE_UINT32 des_index)
{
...
//释放缓存队列
BOOL CTS_BackNetL2::f_FlushPktQueue(ACE_UINT32 des_index)
{
	if (0 == m_vtPeerPktQueue.size())
	{
		return FALSE;
...
CTS_BackNetL2EoSgl1::CTS_BackNetL2EoSgl1()
{
}
...
CTS_BackNetL2EoSgl2::CTS_BackNetL2EoSgl2()
{
}
...
CTS_BackNetL2EoL2::CTS_BackNetL2EoL2()
{
}
...
CTS_BackNetL2EoL3::CTS_BackNetL2EoL3()
{
}
