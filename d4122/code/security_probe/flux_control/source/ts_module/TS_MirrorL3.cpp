...
BOOL CTS_MirrorL3::f_HandleArp(PACKET_INFO_EX& packet_info)
{
	return TRUE;
}

BOOL CTS_MirrorL3::f_HandleIp(PACKET_INFO_EX& packet_info)
{
	//组播不转发
