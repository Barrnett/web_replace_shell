...
ifeq ($(OS), OS_LINUX)
OS_CC           := g++
#OS_CCFLAGS      := -Wall -Wstrict-prototypes -Wno-deprecated -DOS_LINUX -DFLEX_IN_USE -nostartfiles
OS_CCFLAGS      := -w  -Wno-deprecated -DOS_LINUX -DFLEX_IN_USE -fpermissive
#OS_CFLAGS      := -Wall -Wstrict-prototypes -Wno-deprecated -DOS_LINUX -DFLEX_IN_USE -DUSEDFOR_NC3G_FRONT -fpermissive
